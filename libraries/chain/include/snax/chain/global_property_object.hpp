...
#include <snax/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(snax::chain::global_property_object, snax::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(snax::chain::dynamic_global_property_object,
                         snax::chain::dynamic_global_property_multi_index)

FC_REFLECT(snax::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(snax::chain::global_property_object,
