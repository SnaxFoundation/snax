...
using action_name    = snax::chain::action_name;
...
FC_REFLECT( snax::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( snax::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( snax::chain::setabi                           , (account)(abi) )
FC_REFLECT( snax::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( snax::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( snax::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( snax::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( snax::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( snax::chain::onerror                          , (sender_id)(sent_trx) )
