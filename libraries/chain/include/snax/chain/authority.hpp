...
FC_REFLECT(snax::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(snax::chain::key_weight, (key)(weight) )
FC_REFLECT(snax::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(snax::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(snax::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
