...
#include <snax/chain/block_timestamp.hpp>
...
namespace snax { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      snax::chain::abi_def get_abi()const {
         snax::chain::abi_def a;
         SNAX_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(snax::chain::account_object, snax::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(snax::chain::account_sequence_object, snax::chain::account_sequence_index)


FC_REFLECT(snax::chain::account_object, (name)(vm_type)(vm_version)(privileged)(last_code_update)(code_version)(creation_date)(code)(abi))
FC_REFLECT(snax::chain::account_sequence_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence))