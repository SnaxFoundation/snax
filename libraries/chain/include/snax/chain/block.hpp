#pragma once
#include <snax/chain/block_header.hpp>
...
FC_REFLECT_ENUM( snax::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(snax::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(snax::chain::transaction_receipt, (snax::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(snax::chain::signed_block, (snax::chain::signed_block_header), (transactions)(block_extensions) )
