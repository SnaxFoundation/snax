...
CHAINBASE_SET_INDEX_TYPE(snax::chain::table_id_object, snax::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(snax::chain::key_value_object, snax::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(snax::chain::index64_object, snax::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(snax::chain::index128_object, snax::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(snax::chain::index256_object, snax::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(snax::chain::index_double_object, snax::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(snax::chain::index_long_double_object, snax::chain::index_long_double_index)

FC_REFLECT(snax::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(snax::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(snax::chain::index64_object)
REFLECT_SECONDARY(snax::chain::index128_object)
REFLECT_SECONDARY(snax::chain::index256_object)
REFLECT_SECONDARY(snax::chain::index_double_object)
REFLECT_SECONDARY(snax::chain::index_long_double_object)
