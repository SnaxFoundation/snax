...
CHAINBASE_SET_INDEX_TYPE(snax::chain::permission_link_object, snax::chain::permission_link_index)

FC_REFLECT(snax::chain::permission_link_object, (account)(code)(message_type)(required_permission))
