...
CHAINBASE_SET_INDEX_TYPE(snax::chain::permission_object, snax::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(snax::chain::permission_usage_object, snax::chain::permission_usage_index)

FC_REFLECT(snax::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(snax::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(snax::chain::permission_usage_object, (last_used))
