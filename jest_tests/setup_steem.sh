...
clisnax create account snax test3 SNAX74owX6TWxsbQDgYbHnwiae8ssQeCzShHE9pdSEDxo46e25yKxe SNAX74owX6TWxsbQDgYbHnwiae8ssQeCzShHE9pdSEDxo46e25yKxe
clisnax create account snax test4 SNAX74owX6TWxsbQDgYbHnwiae8ssQeCzShHE9pdSEDxo46e25yKxe SNAX74owX6TWxsbQDgYbHnwiae8ssQeCzShHE9pdSEDxo46e25yKxe
...
clisnax push action snax.token issue '["snax", "100000000.0000 SNAX", "to create accounts"]' -p snax@active
clisnax set contract snax ../build/contracts/test_snax.system -p snax@owner -x 1000
clisnax system newaccount snax p.steem SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV -p snax@active --stake-cpu="15000.0000 SNAX" --stake-net="10000.0000 SNAX" --buy-ram-kbytes=1000
...
clisnax push action snax setpriv '["p.steem", 1]' -p snax@active
