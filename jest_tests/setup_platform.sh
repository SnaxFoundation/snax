...
clisnax push action snax setplatforms '[[{ "account": "platform", "period": 1, "weight": 1, "quotas": {  "cpu_weight": 150000000, "net_weight": 150000000, "ram_bytes": 10000000 } }]]' -p snax@active
