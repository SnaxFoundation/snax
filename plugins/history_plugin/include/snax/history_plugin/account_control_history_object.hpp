...
CHAINBASE_SET_INDEX_TYPE( snax::account_control_history_object, snax::account_control_history_multi_index )

FC_REFLECT( snax::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
