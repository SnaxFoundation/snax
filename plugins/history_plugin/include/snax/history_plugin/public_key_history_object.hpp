...
CHAINBASE_SET_INDEX_TYPE( snax::public_key_history_object, snax::public_key_history_multi_index )

FC_REFLECT( snax::public_key_history_object, (public_key)(name)(permission) )
