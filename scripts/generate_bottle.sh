...
mkdir -p ${PROJECT}/${VERSION}/opt/snax/lib/cmake
...
echo "class Snax < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/SnaxFoundation/snax/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/SnaxFoundation/snax/releases/download/v${VERSION}\"
