...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricardsnax.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) != 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricardsnax.py import /snax/contracts/contract/mycontract.abi /snax/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) != 3:
            ...
            print('Usage: ./ricardsnax.py export /snax/contracts/contract/mycontract.abi')
