...
class Utils:
    ...
    MiscSnaxClientArgs="--no-auto-kxd"

    SnaxWalletName="kxd"
    SnaxWalletPath="programs/kxd/"+ SnaxWalletName

    SnaxServerName="snaxnode"
    SnaxServerPath="programs/snaxnode/"+ SnaxServerName

    SnaxLauncherPath="programs/snax-launcher/snax-launcher"
    MongoPath="mongo"
    ShuttingDown=False
    CheckOutputDeque=deque(maxlen=10)

    SnaxBlockLogPath="programs/snax-blocklog/snax-blocklog"
    ...
    def getBlockLog(blockLogLocation, silentErrors=False, exitOnError=False):
        ...
        cmd="%s --blocks-dir %s --as-json-array" % (Utils.SnaxBlockLogPath, blockLogLocation)
