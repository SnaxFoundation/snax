...
try:
    ...
    specificExtraSnaxnodeArgs={}
    # producer nodes will be mapped to 0 through totalProducerNodes-1, so the number totalProducerNodes will be the non-producing node
    specificExtraSnaxnodeArgs[totalProducerNodes]="--plugin snax::test_control_api_plugin"
    ...
    if cluster.launch(prodCount=prodCount, onlyBios=False, topo="bridge", pnodes=totalProducerNodes,
                      ...
                      useBiosBootFile=False, specificExtraSnaxnodeArgs=specificExtraSnaxnodeArgs) is False:
    ...
    testWallet=walletMgr.create(testWalletName, [cluster.snaxAccount,accounts[0],accounts[1],accounts[2],accounts[3],accounts[4]])
    ...
    for account in accounts:
        ...
        trans=node.createInitializeAccount(account, cluster.snaxAccount, stakedDeposit=0, waitForTransBlock=True, stakeNet=1000, stakeCPU=1000, buyRAM=20000, exitOnError=True)
