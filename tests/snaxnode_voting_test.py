...
try:
    ...
    for account in accounts:
        ...
        trans=node.createInitializeAccount(account, cluster.snaxAccount, stakedDeposit=0, waitForTransBlock=False, stakeNet=1000, stakeCPU=1000, buyram=100000, exitOnError=True)
