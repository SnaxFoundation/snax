...
class Cluster(object):
    ...
    def launch(self, pnodes=1, totalNodes=1, prodCount=1, topo="mesh", p2pPlugin="net", delay=1, onlyBios=False, dontBootstrap=False,
               totalProducers=None, extraNodsnaxArgs=None, useBiosBootFile=True, specificExtraNodsnaxArgs=None):
        """Launch cluster.
        ...
        specificExtraNodsnaxArgs: dictionary of arguments to pass to a specific node (via --specific-num and
        ...
        if specificExtraNodsnaxArgs is not None:
            assert(isinstance(specificExtraNodsnaxArgs, dict))
            for nodeNum,arg in specificExtraNodsnaxArgs.items():
