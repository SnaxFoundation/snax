...
#ifdef DISABLE_SNAXLIB_SERIALIZE
#include <snaxlib/serialize.hpp>
#undef SNAXLIB_SERIALIZE
#define SNAXLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  SNAXLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   SNAXLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   SNAXLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   SNAXLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
