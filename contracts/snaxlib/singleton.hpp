...
namespace  snax {
    ...
    *  @brief Defines SNAX Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         SNAXLIB_SERIALIZE( row, (value) )
      };

      typedef snax::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            snax_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
