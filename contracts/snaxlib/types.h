 ...
 * @details SNAX Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
 ...
 * @details SNAX Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of SNAX Transaction Id
 * @details Type of SNAX Transaction Id. It is 256-bit hash
 */
