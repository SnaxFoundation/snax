 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every SNAX contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for SNAX contract.
 * @details %Base class for SNAX contract. %A new contract should derive from this class, so it can make use of SNAX_ABI macro.
 */
class contract {
   public:
      /**
