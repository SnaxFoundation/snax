   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { snax_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { snax_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            snax_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return snax::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline snax::datastream<Stream>& operator>> (snax::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline snax::datastream<Stream>& operator<< (snax::datastream<Stream>& ds, const optional& op)
         {
