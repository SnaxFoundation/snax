 ...
 *  @brief Defines an interface to SNAX database
 *  @ingroup database
 *
 *  @details
 *  SNAX organizes data according to the following broad structure:
 ...
 *  @ingroup database
 *
 *  @details Database C API provides low level interface to SNAX database.
 *
...
/**
  ...
  *  snax_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
...
/**
  ...
  *  snax_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  snax_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
