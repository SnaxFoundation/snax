 ...
 *  snax::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  snax::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  snax::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  snax::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  snax_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  snax::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
