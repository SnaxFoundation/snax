...
#include <snax/abi_generator/abi_generator.hpp>
...
auto get_resolver(const abi_def& abi = abi_def())
{
   return [&abi](const account_name &name) -> optional<abi_serializer> {
      return abi_serializer(snax_contract_abi(abi), max_serialization_time);
   };
}
...
{ try {
   ...
   abi_serializer abis(snax_contract_abi(abi), max_serialization_time);
...
using namespace snax::unittests::config;

struct abi_gen_helper {

  abi_gen_helper() {}

  static bool is_abi_generation_exception(const snax::abi_generation_exception& e) { return true; };

  bool generate_abi(const char* source, const char* abi, bool opt_sfs=false) {

    std::string include_param = std::string("-I") + snaxlib_path;
    ...
    std::string stdcpp_include_param = std::string("-I") + snaxlib_path + "/libc++/upstream/include";
    std::string stdc_include_param = std::string("-I") + snaxlib_path +  "/musl/upstream/include";

    abi_def output;
    output.version = "snax::abi/1.0";
    ...
    bool res = runToolOnCodeWithArgs(
      new find_snax_abi_macro_action(contract, actions, ""),
      source,
      extra_args
    );
    FC_ASSERT(res == true);
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unknown_type, ""), snax::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(double_base, ""), snax::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unable_to_determine_index, ""), snax::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_type_different_namespace, ""), snax::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(bad_index_type, "{}"), snax::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(union_table, ""), snax::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_action_different_type, ""), snax::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
} FC_LOG_AND_RETHROW() }
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(abigen_vector_multidimension, ""), snax::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
BOOST_FIXTURE_TEST_CASE(abigen_snaxabi_macro, abi_gen_helper)
{ try {

   const char* abigen_snaxabi_macro = R"=====(
      ...
      struct hello : public snax::contract {
        public:
   ...
   const char* abigen_snaxabi_macro_abi = R"=====(
   {
     "version": "snax::abi/1.0",
     "types": [],
     "structs": [{
   ...
   BOOST_TEST( generate_abi(abigen_snaxabi_macro, abigen_snaxabi_macro_abi) == true );
...
BOOST_FIXTURE_TEST_CASE(abigen_no_snaxabi_macro, abi_gen_helper)
{ try {

   const char* abigen_no_snaxabi_macro = R"=====(
      #pragma GCC diagnostic push
      #pragma GCC diagnostic ignored "-Wpointer-bool-conversion"
      #include <snaxlib/snax.hpp>
      #include <snaxlib/print.hpp>
   ...
   const char* abigen_no_snaxabi_macro_abi = R"=====(
   {
     "version": "snax::abi/1.0",
     "types": [],
     "structs": [{
   ...
   BOOST_TEST( generate_abi(abigen_no_snaxabi_macro, abigen_no_snaxabi_macro_abi) == true );
...
{ try {
   ...
   auto abi = snax_contract_abi(fc::json::from_string(my_abi).as<abi_def>());

   abi_serializer abis(abi, max_serialization_time);

   const char *my_other = R"=====(
    {
      "publickey"     :  "SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
      "publickey_arr" :  ["SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"],
      "asset"         : "100.0000 SNAX",
      "asset_arr"     : ["100.0000 SNAX","100.0000 SNAX"],
      ...
      "keyweight": {"key":"SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},
      "keyweight_arr": [{"key":"SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":100},{"key":"SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":200}],
...
{ try {
   ...
   auto abi = snax_contract_abi(fc::json::from_string(typedef_cycle_abi).as<abi_def>());
...
{ try {
   ...
   abi_serializer abis(snax_contract_abi(abi_def()), max_serialization_time);
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "auth" : {
        ...
        "keys" : [ {"key" : "SNAX65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "SNAX5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   BOOST_TEST("SNAX65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)updauth.auth.keys[0].key);
   BOOST_TEST(57005u == updauth.auth.keys[0].weight);
   BOOST_TEST("SNAX5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)updauth.auth.keys[1].key);
...
{ try {
   ...
   BOOST_TEST("SNAX65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newacct.owner.keys[0].key);
   BOOST_TEST(57005u == newacct.owner.keys[0].weight);
   BOOST_TEST("SNAX5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newacct.owner.keys[1].key);
   ...
   BOOST_TEST("SNAX65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newacct.active.keys[0].key);
   BOOST_TEST(57005u == newacct.active.keys[0].weight);
   BOOST_TEST("SNAX5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newacct.active.keys[1].key);
...
{ try {
   ...
   abi_serializer abis(snax_contract_abi(v.as<abi_def>()), max_serialization_time);
...
{ try {
   ...
   auto abi = snax_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
...
BOOST_AUTO_TEST_CASE(abi_account_name_in_snax_abi)
{ try {
   // inifinite loop in types
   const char* repeat_abi = R"=====(
   {
...
BOOST_AUTO_TEST_CASE(abi_large_array)
{
   try {
      ...
      // curl http://127.0.0.1:8888/v1/chain/abi_bin_to_json -X POST -d '{"code":"snax", "action":"hi", "binargs":"ffffffff08"}'
...
{
   using snax::testing::fc_exception_message_starts_with;
...
BOOST_AUTO_TEST_CASE(version)
{
   try {
      ...
      BOOST_CHECK_THROW( abi_serializer(fc::json::from_string(R"({"version": "snax::abi/9.0"})").as<abi_def>(), max_serialization_time), unsupported_abi_version_exception );
      abi_serializer(fc::json::from_string(R"({"version": "snax::abi/1.0"})").as<abi_def>(), max_serialization_time);
      abi_serializer(fc::json::from_string(R"({"version": "snax::abi/1.1"})").as<abi_def>(), max_serialization_time);
   } FC_LOG_AND_RETHROW()
}
...
{
   using snax::testing::fc_exception_message_is;
