...
//extern uint32_t SNAX_TESTING_GENESIS_TIMESTAMP;
...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("SNAX_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      SNAX_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "SNAX_TESTING_GENESIS_TIMESTAMP is " << SNAX_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}
